          ...
          if (!existing_rec) {
            ...
            try {
              ...
              if (validatedUpdates.error)
                ...
                let query = {_id: ObjectID(formdef.parent.query._id), partition_key: 0}, update
            ...
            try {
              ...
              if (validatedUpdates.error)
                ...
                var update = { '$set': validatedUpdates.data },
                      query = {_id:  ObjectID(userdoc._id), partition_key: 0}

                if (formdef.form.store === 'metadata') {
                  update = { '$set': {'_data': validatedUpdates.data}}
                  query = {_id:  formdef.form._id, partition_key: 0}
              ...
              if (!isArray) {
                try {
                  ...
                  if (formdef.form._id === FORM_METADATA_ID && insert.store === "mongo") {
                    ...
                    try {
                      await db.command({ shardCollection: `${options.dbname}.${insert.collection}`, key: { partition_key:  "hashed" }})
